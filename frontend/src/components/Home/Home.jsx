...
import StudentDetail from './teach'
class Home extends Component {
    ...
    crossstudentDetail=()=>this.setState({studentKey:''})
    render() { 
            ...
            <div>
                <div className={styles.searchBlock}>
                    <div className="row">
                        ...
                        <div className="col">
                            <button className="btn btn-danger btn-sm" style={{margin:"10px 10px 1px 100px"}}>+ Add student</button>
                        </div>
                    </div>
                </div>
